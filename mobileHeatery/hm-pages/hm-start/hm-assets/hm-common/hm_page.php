    ...
    <li id="hm_navbar_dropdown" class="dropdown">
        ...
        <ul id="hm_navbar_dropdown_ul" class="dropdown-menu">
            ...
            <li>
                ...
                <button id="btn-belgium" class="btn btn-default btn-sm" type="button" onclick="" data-toggle="tooltip">
                ...
                <li>
                    ...
                    <button id="btn-redee" class="btn btn-default btn-sm" type="button" onclick="" data-toggle="tooltip">
                ...
                <li>
                    ...
                    <button id="btn-pink" class="btn btn-default btn-sm" type="button" onclick="" data-toggle="tooltip">
                ...
                <li>
                    ...
                    <button id="btn-roots" class="btn btn-default btn-sm" type="button" onclick="" data-toggle="tooltip">
