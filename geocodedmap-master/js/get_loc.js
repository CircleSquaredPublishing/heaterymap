...
/************************************************************\
*captures user input from the address
text input element and passes it to the HTML geolocation API.
The desing intent being for the initial heatmap to reflect the 
