...
*/
?>
<?php require 'assets/common/am_header.php'; ?>
<?php require 'assets/common/am_nav.php';?>
<div id="map-canvas"></div>
<?php require 'assets/common/am_sidebar.php';?>
<script src="assets/js/am_main.js"></script>
<script src="assets/js/am_query.js"></script>
<?php require 'assets/common/am_footer.php';?>