<?php
/*
Directory Location: github/home_page
File Name: index.php
...
<?php require 'assets/common/hp_header.php';?>
    ...
    <?php require 'assets/common/hp_navbar.php';?>
        ...
        <?php require 'assets/common/hp_sidebar_right.php';?>

            <?php require 'assets/common/hp_page.php'; ?>

                <script src="assets/js/hp_heatmap_min.js"></script>

                <script src="assets/js/hp_main.js"></script>
